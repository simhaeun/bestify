      ...
      <Container>
        ...
        {/* <GridContainer data-aos="fade-up" data-aos-delay="150">
          {product.map((item, index) => {
            return (
              <Link href={`/productDetail/post${index + 1}`} key={item.index}>
              <Link href={`/productDetail/post1`} key={item.index}>
                <Item>
                  <ImageWrap>
                    {<Image
                        src={item.imgSrc}
        ...
        <Grid data-aos="fade-up" data-aos-delay="150">
          ...
          <Card>
            <CardHeader>
              ...
              <p>월 99만원 * 3개월 = 297만원 (정상가 480만원)</p>
            </CardHeader>
            <CardCont>
              <ul>
                <li>상세 상권, 고객 분석</li>
